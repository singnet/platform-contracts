...
const OWNER = '0xe71798b14a87c9f80f66ad0e148a65a1cc56b73b'
...
//constants 
const AGENT_FACTORY_ADDRESS = '0xc2950c3526254417351438babe5f2100cba90bf2'
...
async function joinNetwork() {
  return await new Promise((resolve,reject) =>{
    agentFactoryContract.methods.create().call({from:OWNER})
      .then((result) => {
        resolve(result)
      })
  }) 
