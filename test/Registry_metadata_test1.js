...
contract('Registry', function(accounts) {
    ...
    it ("set/get metadata", async function()
        ...
        it ("Delete Operations as contractOwner", async function()
        { 
            ...
            // Check for contractOwner
            const contractOwner = await registry.contractOwner.call();
        ...
        it ("Negative test cases as contractOwner", async function()
        { 
            ...
            // Negative Test - Test adding Tags using contractOwner - Should Revert
